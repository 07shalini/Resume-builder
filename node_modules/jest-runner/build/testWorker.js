'use strict';
/* build-hook-start *//*00001*/try { require('/Users/princevishal/.cursor/extensions/wallabyjs.console-ninja-1.0.432/out/buildHook/index.js').default({tool: 'jest', checkSum: '2081bdef9c35117c990c8fCgZMUUtXAwABUAEGVltbAFUFXgMO', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/princevishal/.cursor/extensions/wallabyjs.console-ninja-1.0.432/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '2081bdef9c35117c990c8fCgZMUUtXAwABUAEGVltbAFUFXgMO', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
